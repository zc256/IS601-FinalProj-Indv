...
CREATE TABLE IF NOT EXISTS mlb_players_1 (
    `id` int AUTO_INCREMENT,
    `Player` VARCHAR(19) CHARACTER SET utf8,
...
INSERT INTO mlb_players_1 (Player,Team,Position,Height_inches,Weight_lbs,Age) VALUES
